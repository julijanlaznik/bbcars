  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#050505] text-white">
      ...
      <aside className={`fixed top-0 left-0 h-full w-full md:w-[450px] bg-black z-[110] transition-transform duration-700 p-8 md:p-14 flex flex-col border-r border-white/5 ${isMenuOpen ? 'translate-x-0' : '-translate-x-full'}`}>
        ...
        <nav className="flex flex-col space-y-6 md:space-y-4 overflow-y-auto pr-4 custom-scrollbar flex-grow">
          {menuLinks.map((link) => (
            <Link 
              key={link.to} 
              to={link.to} 
        ...
        <div className="pt-10 flex items-center space-x-6 border-t border-white/5 mt-auto">
          <a href="https://instagram.com/bbcars.eu" target="_blank" className="text-white/20 hover:text-white transition-colors group">
          ...
          <a href="https://facebook.com/bbcars.eu" target="_blank" className="text-white/20 hover:text-white transition-colors group">
