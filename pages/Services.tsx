    ...
    <div className="fade-in bg-[#050505] min-h-screen pb-40">
      ...
      <section className="py-24 px-8 md:px-20 max-w-screen-2xl mx-auto border-t border-white/5">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20">
          <div>
            ...
            <div className="space-y-8 text-white/50 font-light">
              ...
              <div className="pt-8 border-t border-white/5">
                <p className="text-3xl font-bold text-white mb-2">Cena od 15 Kč/km <span className="text-sm font-normal text-white/40">bez DPH</span></p>
          ...
          <div className="relative h-[400px] lg:h-auto overflow-hidden border border-white/5">
      ...
      <section className="py-24 px-8 md:px-20 max-w-screen-2xl mx-auto border-t border-white/5">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20">
          <div className="order-2 lg:order-1">
            <div className="grid grid-cols-2 md:grid-cols-3 gap-[2px] bg-white/5 opacity-40">
              {partners.map(p => (
                <div key={p} className="flex items-center justify-center p-8 bg-black border border-transparent text-[12px] font-bold tracking-widest hover:text-[#dbad1e] hover:opacity-100 transition-all uppercase">
                  {p}
                </div>
              ))}
            </div>
          ...
          <div className="order-1 lg:order-2">
            ...
            <div className="space-y-12">
              <div>
                ...
                <p className="text-white/40 text-xl font-light leading-relaxed">Díky spolupráci s předními českými finančními institucemi dokážeme nabídnout individuální splátkové kalendáře a výhodné úrokové sazby pro soukromé i firemní účely.</p>
              </div>
              <div className="pt-8 border-t border-white/5">
                <h3 className="text-3xl font-bold mb-4 uppercase font-heading">Komplexní pojištění</h3>
                <p className="text-white/40 text-xl font-light leading-relaxed mb-8">Zajišťujeme kompletní pojistný servis, aby váš vůz byl chráněn od prvního kilometru.</p>
                <div className="flex flex-col md:flex-row gap-6">
                  <div className="flex-1 p-8 bg-[#080808] border border-white/5">
                    <p className="font-bold text-xl uppercase font-heading">Povinné ručení</p>
                  </div>
                  <div className="flex-1 p-8 bg-[#080808] border border-white/5">
                    <p className="font-bold text-xl uppercase font-heading">Havarijní pojištění</p>
                  </div>
                </div>
              </div>
            </div>
