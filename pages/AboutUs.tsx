...
const AboutUs: React.FC<AboutUsProps> = ({ lang }) => {
  ...
  return (
    <div className="fade-in bg-[#050505] selection:bg-white selection:text-black">
      ...
      {/* 1. CINEMATIC HERO - THE MANIFESTO */}
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div ref={heroReveal.elementRef} className={`relative z-10 text-center px-8 max-w-5xl transition-all duration-[1200ms] cubic-bezier(0.23, 1, 0.32, 1) ${heroReveal.isVisible ? 'opacity-100 translate-y-0 blur-0 scale-100' : 'opacity-0 translate-y-20 blur-xl scale-95'}`}>
           <span className="block text-[10px] uppercase tracking-[1em] text-white/30 mb-12 font-bold animate-pulse">ESTABLISHED 2009</span>
           <h1 className="text-5xl md:text-8xl lg:text-9xl font-bold tracking-tighter uppercase font-heading leading-[0.85] mb-12">
      ...
      {/* 2. THE STORY - TWO COLUMN NARRATIVE */}
      <section className="py-40 px-8 md:px-20 max-w-screen-2xl mx-auto border-t border-white/5">
        <div ref={visionReveal.elementRef} className={`grid grid-cols-1 lg:grid-cols-2 gap-20 items-start transition-all duration-[1500ms] ${visionReveal.isVisible ? 'opacity-100 translate-y-0 scale-100' : 'opacity-0 translate-y-32 scale-95'}`}>
          <div>
            <h2 className="text-[10px] uppercase tracking-[0.5em] text-white/20 mb-12 font-bold">NAŠE VIZE</h2>
            <p className="text-3xl md:text-5xl font-bold font-heading uppercase tracking-tighter leading-[1.1] text-white">
              {lang === 'CZ' 
          ...
          <div className="space-y-10 pt-4">
            <p className="text-xl md:text-2xl font-light leading-relaxed text-white/40">
              {lang === 'CZ'
      ...
      {/* 3. THE TEAM - LIVELIER ANIMATIONS */}
      <section className="py-40 bg-[#080808] border-y border-white/5 overflow-hidden">
        <div ref={teamReveal.elementRef} className="px-8 md:px-20 max-w-screen-2xl mx-auto">
          <h2 className={`text-[10px] uppercase tracking-[0.5em] text-white/20 mb-20 font-bold text-center transition-all duration-1000 ${teamReveal.isVisible ? 'opacity-100' : 'opacity-0 translate-y-10'}`}>LIDÉ ZA BBCARS</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-[2px] bg-white/5 max-w-5xl mx-auto">
            ...
            <div className={`bg-[#050505] p-12 flex flex-col items-center text-center group transition-all duration-[1200ms] delay-100 cubic-bezier(0.34, 1.56, 0.64, 1) ${teamReveal.isVisible ? 'opacity-100 translate-y-0 scale-100' : 'opacity-0 translate-y-32 scale-75'}`}>
              ...
              <h3 className="text-2xl font-bold font-heading uppercase tracking-tight mb-4 group-hover:text-[#FACC15] transition-colors">Jakub Buršík</h3>
            ...
            <div className={`bg-[#050505] p-12 flex flex-col items-center text-center group transition-all duration-[1200ms] delay-300 cubic-bezier(0.34, 1.56, 0.64, 1) ${teamReveal.isVisible ? 'opacity-100 translate-y-0 scale-100' : 'opacity-0 translate-y-32 scale-75'}`}>
              ...
              <h3 className="text-2xl font-bold font-heading uppercase tracking-tight mb-4 group-hover:text-[#FACC15] transition-colors">Jan Buršík</h3>
              <p className="text-sm font-light text-white/40 leading-relaxed max-w-xs">
      ...
      <section className="py-40 px-8 md:px-20 max-w-screen-2xl mx-auto">
        <div ref={pillarsReveal.elementRef} className="grid grid-cols-1 md:grid-cols-3 gap-16">
          {[
            ...
            >
              <div className="w-12 h-12 mb-8 flex items-center justify-center border border-white/5 bg-white/[0.02] group-hover:border-[#FACC15] group-hover:bg-[#FACC15]/5 group-hover:scale-110 transition-all duration-700">
                <svg className="w-5 h-5 text-white/30 group-hover:text-[#FACC15] transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1" d={pillar.icon}/>
                </svg>
              </div>
              <h3 className="text-xl font-bold font-heading uppercase tracking-tight mb-4 group-hover:text-[#FACC15] transition-colors">{pillar.title}</h3>
      ...
      {/* 5. ATMOSPHERIC QUOTE - BLUR IN */}
      <section className="relative py-60 bg-[#050505] overflow-hidden">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[120%] h-[120%] opacity-10 blur-3xl">
        ...
        <div ref={quoteReveal.elementRef} className={`max-w-screen-2xl mx-auto px-8 md:px-20 text-center relative z-10 transition-all duration-[2000ms] ${quoteReveal.isVisible ? 'opacity-100 scale-100 blur-0' : 'opacity-0 scale-95 blur-2xl translate-y-20'}`}>
           <blockquote className="text-3xl md:text-6xl font-light tracking-tight italic opacity-40 mb-20 leading-tight">
             {lang === 'CZ' 
           ...
           <div className="flex flex-col md:flex-row justify-center items-center gap-8">
              ...
              <span className="text-white/20 text-[10px] tracking-[0.3em] font-bold uppercase">{lang === 'CZ' ? 'NEBO' : 'OR'}</span>
              <a href="tel:+420605034911" className="text-[10px] uppercase tracking-[0.6em] font-bold py-5 px-16 bg-white text-black hover:bg-[#FACC15] transition-all duration-500">
